      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Archangels of Kyiv.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Archangels of Kyiv, accessible
            from{' '}
            <a
              href="https://www.archangels.in.ua"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://www.archangels.in.ua
            </a>
          </p>
        </li>
        <li>
