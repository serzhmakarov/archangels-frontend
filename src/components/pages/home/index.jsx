    ...
    <Container fluuid className="home-page">
      <Row className="home-page__title-block content-wrapper">
        ...
        <div className="home-page__title-block-right-side">
          <img className="home-page__title-block-image" src={MainPageImage} />
        </div>
      </Row>
      ...
      <Row className="home-page__help-content-container content-wrapper">
       ...
       <Col xs={8}>
        <div>
            ...
            <p>Щомісяця ми публікуємо <a href="#" className="home-page__hyperlink">фінансові звіти</a>. Все прозоро, всі гроші йдуть на допомогу армії.</p>
