    ...
    >
      ...
      <Modal.Body>
        ...
        <Form onSubmit={handleSubmit} className="authorization-modal__form">
          <Form.Group controlId="formBasicEmail" className="authorization-modal__form-group">
          ...
          <Form.Group controlId="formBasicPassword" className="authorization-modal__form-group">
